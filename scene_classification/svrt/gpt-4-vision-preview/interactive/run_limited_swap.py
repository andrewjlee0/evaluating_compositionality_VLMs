...
with open('results/limited_swap/randomized_trial_sequence_dict.pkl', 'wb') as file:
...
for problem in problem_sequence:
    ...
    for trial, file_path in enumerate(randomized_trial_sequence, 1):
        ...
        # SWAP CATEGORY LABEL
        category = 1 if category==0 else 0
        ...
        while response_inappropriate:
            ...
            try:
                ...
                # Save convo history
                with open(f'results/limited_swap/{problem}_convo_history.pkl', 'wb') as file:
        ...
        save_path = f'results/limited_swap/{problem}_limited_results.csv'
