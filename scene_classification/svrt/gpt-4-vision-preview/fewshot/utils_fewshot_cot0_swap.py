...
def construct_convo(incontext_images, query_image, instruction_message, incontext_message, query_message):
    convo = [
    ...
    for idx_incontext, filename in enumerate(incontext_images):
        ...
        incontext_image_data_url = local_image_to_data_url(filename)
