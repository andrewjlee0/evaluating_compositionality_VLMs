...
from utils_fewshot_cot2 import *
...
for test_condition, test_dataset in test_dataset_dict.items():
    ...
    for idx_test_item, test_item in enumerate(test_dataset):
        ...
        if test_condition == 'test_unseen_obj_seen_act' and idx_test_item < 245:
            continue
        elif test_condition == 'test_unseen_obj_seen_act' and idx_test_item == 245:
