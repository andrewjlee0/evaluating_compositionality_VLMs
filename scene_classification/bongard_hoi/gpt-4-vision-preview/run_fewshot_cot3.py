...
for test_condition, test_dataset in test_dataset_dict.items():
    ...
    for idx_test_item, test_item in enumerate(test_dataset):
        ...
        # if test_condition == 'test_seen_obj_seen_act' and idx_test_item < 249:
        #     continue
        # elif test_condition == 'test_seen_obj_seen_act' and idx_test_item == 249:
        #     data = pd.read_csv(f'results/{cotN}/test_seen_obj_seen_act_fewshot_results.csv')
