...
def update_convo(convo, incontext_image=None, incontext_image_category=None, incontext_message=None, idx_incontext=None, query_image=None, query_message=None, assistant_message=None):

    if incontext_image is not None:

        # Encode into data url
        incontext_image_data_url = tensor_to_data_url(incontext_image)
