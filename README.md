...
This is the official implementation of Fu,* Lee,* Wang, Momennejad, Bihl, Lu, & Webb (in press). Evaluating Compositional Scene Understanding in Multimodal Generative Models. _Transactions of Machine Learning Research_.
